        ...
        try {
            ...
            switch (message.getCommand()) {
                ...
                case WebrtcMessage.TYPE_COMMAND_ROOM_CREATE:
                    webrtcRoomService.createRoom(message.getRoomId(), message.getRoomPw(), this, message.getMessage(),message.getUserId());
                    break;
                case WebrtcMessage.TYPE_COMMAND_ROOM_ENTER:
                    webrtcRoomService.enterRoom(message.getRoomId(), message.getRoomPw(), this, message.getMessage(),message.getUserId());
                    break;
                case WebrtcMessage.TYPE_COMMAND_GETUSER:
                    webrtcRoomService.getRoomUsers(message.getRoomId());
